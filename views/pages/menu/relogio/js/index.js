...
(function () {
  ...
  setCaptions = function () {
    ...
    $('.clockArc.hour').attr('d', describeArc(600, 230, 150, 0, hourArc));
    $('.clockArc.minute').attr('d', describeArc(600, 230, 170, 0, minArc));
    $('.clockDot.hour').attr('d', describeArc(600, 230, 150, hourArc - 3, hourArc));
    $('.clockDot.minute').attr('d', describeArc(600, 230, 170, minArc - 1, minArc));
    dot = $(".clockDot.hour");
    pos = polarToCartesian(600, 230, 150, hourArc);
    dot.attr("cx", pos.x);
    dot.attr("cy", pos.y);
    dot = $(".clockDot.minute");
    pos = polarToCartesian(600, 230, 170, minArc);
    dot.attr("cx", pos.x);
    dot.attr("cy", pos.y);
    return $('#time').text(moment().format('HH:mm'));
  };
